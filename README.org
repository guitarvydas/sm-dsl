...
type "rawText" #<STACK-DSL::STRING-DESCRIPTOR {100413A643}>
type "onName" #<STACK-DSL::STRING-DESCRIPTOR {100413A6A3}>
type "name" #<STACK-DSL::STRING-DESCRIPTOR {100413A703}>
type "exprkind" #<STACK-DSL::ENUM-DESCRIPTOR {10041E2453}>
type "callkind" #<STACK-DSL::ENUM-DESCRIPTOR {10041E24B3}>
type "callExpr" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100428A453}>
type "callStatement" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100428A4C3}>
type "sendStatement" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100428A533}>
type "event" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100428A5A3}>
type "machineDescriptor" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100428A613}>
type "state" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100428A683}>
type "rawExpr" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100428A6F3}>
type "dollarExpr" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100428A763}>
type "expressionMap" #<STACK-DSL::MAP-DESCRIPTOR {100431A453}>
type "pipeline" #<STACK-DSL::MAP-DESCRIPTOR {100431A4D3}>
type "statementsBag" #<STACK-DSL::BAG-DESCRIPTOR {10043AA453}>
type "eventsBag" #<STACK-DSL::BAG-DESCRIPTOR {10043AA513}>
type "statesBag" #<STACK-DSL::BAG-DESCRIPTOR {10043AA593}>
type "initiallyDescriptor" #<STACK-DSL::BAG-DESCRIPTOR {10043AA623}>
type "statement" #<STACK-DSL::COMPOUND-DESCRIPTOR {10044425E3}>
type "expression" #<STACK-DSL::COMPOUND-DESCRIPTOR {1004442673}>
