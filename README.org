...
type "rawText" #<STACK-DSL::STRING-DESCRIPTOR {1004022643}>
type "onName" #<STACK-DSL::STRING-DESCRIPTOR {10040226A3}>
type "name" #<STACK-DSL::STRING-DESCRIPTOR {1004022703}>
type "exprkind" #<STACK-DSL::ENUM-DESCRIPTOR {10040BA453}>
type "callkind" #<STACK-DSL::ENUM-DESCRIPTOR {10040BA4B3}>
type "callExpr" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100417A4B3}>
type "callStatement" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100417A523}>
type "sendStatement" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100417A593}>
type "event" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100417A603}>
type "machineDescriptor" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100417A673}>
type "state" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100417A6E3}>
type "rawExpr" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100417A753}>
type "dollarExpr" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100417A7C3}>
type "expressionMap" #<STACK-DSL::MAP-DESCRIPTOR {100420A453}>
type "pipeline" #<STACK-DSL::MAP-DESCRIPTOR {100420A4D3}>
type "statementsMap" #<STACK-DSL::BAG-DESCRIPTOR {100429A453}>
type "eventsBag" #<STACK-DSL::BAG-DESCRIPTOR {100429A513}>
type "statesBag" #<STACK-DSL::BAG-DESCRIPTOR {100429A593}>
type "initiallyDescriptor" #<STACK-DSL::BAG-DESCRIPTOR {100429A623}>
type "statement" #<STACK-DSL::COMPOUND-DESCRIPTOR {100432A453}>
type "expression" #<STACK-DSL::COMPOUND-DESCRIPTOR {100432A4E3}>
