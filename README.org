...
type "rawText" #<STACK-DSL::STRING-DESCRIPTOR {100413AF33}>
type "onName" #<STACK-DSL::STRING-DESCRIPTOR {100413AF93}>
type "name" #<STACK-DSL::STRING-DESCRIPTOR {100413AFF3}>
type "exprkind" #<STACK-DSL::ENUM-DESCRIPTOR {10041E25E3}>
type "callkind" #<STACK-DSL::ENUM-DESCRIPTOR {10041E2643}>
type "callExpr" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100427A453}>
type "callStatement" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100427A4C3}>
type "sendStatement" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100427A533}>
type "event" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100427A5A3}>
type "machineDescriptor" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100427A613}>
type "state" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100427A683}>
type "rawExpr" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100427A6F3}>
type "dollarExpr" #<STACK-DSL::STRUCTURE-DESCRIPTOR {100427A763}>
type "expressionMap" #<STACK-DSL::MAP-DESCRIPTOR {100430AA43}>
type "pipeline" #<STACK-DSL::MAP-DESCRIPTOR {100430AAC3}>
type "statementsMap" #<STACK-DSL::BAG-DESCRIPTOR {100439A453}>
type "eventsBag" #<STACK-DSL::BAG-DESCRIPTOR {100439A513}>
type "statesBag" #<STACK-DSL::BAG-DESCRIPTOR {100439A593}>
type "initiallyDescriptor" #<STACK-DSL::BAG-DESCRIPTOR {100439A623}>
type "statement" #<STACK-DSL::COMPOUND-DESCRIPTOR {1004432453}>
type "expression" #<STACK-DSL::COMPOUND-DESCRIPTOR {10044324E3}>
